      ...
      <div>
        <div className="row">
          <div className="col-md-3" id="leftCol">
            <ul className="nav nav-stacked affix overall-nav" id="sidebar">
              <li><a href="#/getting-started#sec0">Getting Started</a></li>
              <li><a href="#/getting-started#sec1">Choosing Your UI</a></li>
              <li>
                <ul className="nav sub-nav">
                  <li><a href="#/getting-started#sec1-1">Sliding Panel</a></li>
                  <li><a href="#/getting-started#sec1-2">Embedded</a></li>
                </ul>
              </li>
